...
const displayIssuesDetails = (issue) => {
    ...
    <h1 class="font-bold text-2xl">${issue.title}</h1>
            <div class="gap-2 flex">
                <div class="badge badge-success bg-[#00A96E] rounded-full text-white">${issue.status}</div>
            ...
            <p class="py-4 text-[#64748B]">${issue.description}</p>
            <div class="flex bg-gray-100 p-5 rounded-md">
                ...
                <div class="flex-1">
                    ...
                    <p class="badge text-white rounded-full ${issue.priority === 'high' ? 'bg-[#EF4444]' : issue.priority === 'medium' ? 'badge-warning' : 'badge-info'}">${issue.priority}</p>
                </div>
            </div>
